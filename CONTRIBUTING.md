...
If you want to use Android Studio or Xcode to edit the native code, you can open the `example/android` or `example/ios` directories respectively in those editors. To edit the Objective-C or Swift files, open `example/ios/BeaconMeshSDKExample.xcworkspace` in Xcode and find the source files at `Pods > Development Pods > @beaconmesh/react-native`.
